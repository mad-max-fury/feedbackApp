  ...
  return <>
    {
      isLoggedIn ?
        <>
          <Wrap>
            <UserWrapper>
              <div className='userDetails' onClick={() => setShowMiniModal(true)}>
            ...
            {
              showMiniModal ? <MiniModal onClick={() => setShowMiniModal(false)}>
        ...
        : <BtnWrapper onClick={handleSignInPage}><span>Login</span></BtnWrapper>
